...
func (c *chatClient) RouteChat(ctx context.Context, opts ...grpc.CallOption) (Chat_RouteChatClient, error) {
	stream, err := c.cc.NewStream(ctx, &Chat_ServiceDesc.Streams[0], "/pbuf.Chat/RouteChat", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *chatRouteChatClient) Send(m *ClientMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatRouteChatClient) Recv() (*ServerMessage, error) {
	m := new(ServerMessage)
...
func (x *chatRouteChatServer) Send(m *ServerMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatRouteChatServer) Recv() (*ClientMessage, error) {
	m := new(ClientMessage)
